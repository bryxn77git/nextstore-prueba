...
const sendEmailContact = async(req: NextApiRequest, res: NextApiResponse<Data>) => {
    ...
    const mailOptionsCostumer = {
      ...
      * {
      ...
      <table class="hide-mobile" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <table height="0px" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 10px solid #C2BB4F;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
          <tbody>
            <tr style="vertical-align: top">
      ...
      <table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="color: #7a7676; line-height: 170%; text-align: left; word-wrap: break-word;">
          <p style="font-size: 14px; line-height: 170%;">Uno de nuestros vendedores se pondr&aacute; en contacto contigo lo m&aacute;s pronto posible, gracias por su paciencia.</p>
        </div>
      ...
      <table id="u_content_text_15" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="color: #615e5e; line-height: 140%; text-align: right; word-wrap: break-word;">
          <p style="font-size: 14px; line-height: 140%;"><strong><span style="font-size: 14px; line-height: 19.6px;">${fecha.getDate()}/${fecha.getMonth()+1}/${fecha.getFullYear()}</span></strong></p>
        </div>
      ...
      <!--[if (mso)|(IE)]></td><![endif]-->
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                ...
                <img align="center" border="0" src=${product.img} alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 180px;" width="180"/>
          ...
          <table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            ...
            <div class="v-text-align" style="line-height: 140%; text-align: center; word-wrap: break-word;">
              <p style="font-size: 14px; line-height: 140%; text-align: center;"><strong>${product.title.charAt(0).toLocaleUpperCase() + product.title.slice(1)}</strong></p>
            </div>

            <div class="v-text-align" style="line-height: 140%; text-align: center; word-wrap: break-word;">
              <p style="font-size: 14px; line-height: 140%; text-align: center;">Talla: ${product.talla}</p>
            </div>

            <div class="v-text-align" style="line-height: 140%; text-align: center; word-wrap: break-word;">
              <p style="font-size: 14px; line-height: 140%; text-align: center;">Color: ${product.color!.nombre.charAt(0).toLocaleUpperCase() + product.color!.nombre.slice(1)}</p>
            </div>
      ...
      <div class="u-row-container" style="padding: 0px;background-color: transparent">
        <div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #C2BB4F;">
          <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
            <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: #C2BB4F;"><![endif]-->
      ...
      <table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div class="v-text-align" style="color: #ecf7ff; line-height: 140%; text-align: center; word-wrap: break-word;">
          <p style="font-size: 14px; line-height: 140%;">&copy; Next Store Uniforms</p>
        </div>
  ...
  const mailOptionsSegycom = {
      from: 'bryxn.alex77@gmail.com [Citizacion invitado]',
      ...
      ${cart.map( (product: ICartProduct) =>  
          `<ul style="list-style: none;">
              <li><img src="${product.img}" style="width: 100px;"/></li>
              <li>Codigo: ${product.code}</li>
              <li>Nombre: ${product.title}</li>
              <li>Talla: ${product.talla}</li>
              <li>Color: ${product.color?.nombre}</li>
              <li>Cantidad: ${product.quantity}</li>
          </ul>`
      ).join('')}`,
  };

  transporter.sendMail(mailOptionsCostumer, (error: any, info) => {
      if(error){
          res.status(500).send({ message: 'error' });
      } else {
          console.log('Email cliente enviado')
          transporter.sendMail(mailOptionsSegycom, (error, info) => {
              if(error){
                  res.status(500).send({ message: 'error' });
              } else {
                  res.status(200).json(
